...
class ConvolutionalNeuralNetwork:
    ...
    def __init__(self, input_dim=(1, 8, 8),
        ...
        self.params['W7'] = weight_init_scales[6] * \
            np.random.randn(64, hidden_size)
        ...
        # レイヤの生成===========
        self.layers = []
        self.layers.append(ConvolutionLayer(self.params['W1'], self.params['b1'],
                                            conv_param_1['stride'], conv_param_1['pad']))
        self.layers.append(ReluLayer())
        self.layers.append(ConvolutionLayer(self.params['W2'], self.params['b2'],
                                            conv_param_2['stride'], conv_param_2['pad']))
        self.layers.append(ReluLayer())
        self.layers.append(PoolingLayer(pool_h=2, pool_w=2, stride=2))
        self.layers.append(ConvolutionLayer(self.params['W3'], self.params['b3'],
                                            conv_param_3['stride'], conv_param_3['pad']))
        self.layers.append(ReluLayer())
        self.layers.append(ConvolutionLayer(self.params['W4'], self.params['b4'],
                                            conv_param_4['stride'], conv_param_4['pad']))
        self.layers.append(ReluLayer())
        self.layers.append(PoolingLayer(pool_h=2, pool_w=2, stride=2))
        self.layers.append(ConvolutionLayer(self.params['W5'], self.params['b5'],
                                            conv_param_5['stride'], conv_param_5['pad']))
        self.layers.append(ReluLayer())
        self.layers.append(ConvolutionLayer(self.params['W6'], self.params['b6'],
